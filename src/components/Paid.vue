...
mounted(){
   this.users = this.$store.state.Users.filter((item)=>item.paidStatus == "Paid")
}
  ,
          ...
          <tr v-for="user in users" :key="user.email">
            ...
            <td class="">
              ...
              <td class="flex flex-col gap-[2px]">
                <span v-bind:class="{
                  'bg-[#E6E6F2]  px-[4px] rounded-full text-[#6767FD] w-[80px] font-bold flex h-[23px]': user.online == 'Active',
              ...
              <td class="">
                  <span v-bind:class="{
                  'bg-[#CDFFCD]  px-[4px] rounded-full text-[#0D870D] w-[55px]  font-bold flex h-[23px] ': user.paidStatus == 'Paid',
                  'bg-[#FFECCC]  px-[4px] rounded-full text-[#965E00] w-[80px]  font-bold flex h-[23px]': user.paidStatus == 'Unpaid',
                    'bg-[#FFE0E0]  px-[4px] rounded-full text-[#D81C1C] w-[80px]  font-bold flex h-[23px]': user.paidStatus == 'Overdue'
